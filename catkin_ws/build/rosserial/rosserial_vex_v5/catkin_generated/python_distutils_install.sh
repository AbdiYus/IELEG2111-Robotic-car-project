...
echo_and_run cd "/home/mosa/IELEG2111-Robotic-car-project/catkin_ws/src/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/mosa/IELEG2111-Robotic-car-project/catkin_ws/src/rosserial/rosserial_vex_v5/setup.py" \
     \
    build --build-base "/home/mosa/IELEG2111-Robotic-car-project/catkin_ws/build/rosserial/rosserial_vex_v5" \
    install \
    --root="${DESTDIR-/}" \
