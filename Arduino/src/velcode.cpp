...
void right_wheel_tick() {
 ...
 /*
 will set the direction of the wheel based on the value of the encoder
 if the wheel is moving forward, the value of the encoder will be LOW
 one rotation isnt 1 tick.


 when the wheel changes it will send i sginal 1 or 0 depending if the wheel is reversing or moving forward
 here will bind it to a varaiabel.
 */
  if (val == LOW) {
